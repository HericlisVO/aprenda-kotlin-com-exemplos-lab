...
fun main() {
    ...
    val hericlis = Users("Hericlis ","Ventura", "hericlisventura.o@gmail.com", Post.STUDENT)
    val black = Users("Black","White", "black@gmail.com", Post.STUDENT)
    ...
    androidTraining.addUser(hericlis)
    androidTraining.addUser(black)
